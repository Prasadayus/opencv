...
* - [OpenCV installation overview](general_install/general_install.md)
  - Overview of prebuilt and source-build installation paths across supported platforms.
* - [OpenCV configuration options reference](config_reference/config_reference.md)
  - Reference for every CMake build flag OpenCV exposes and how to set them.
* - [OpenCV environment variables reference](env_reference/env_reference.md)
...
* - [Installation in Windows](windows_install/windows_install.md)
  - Prebuilt-library and source-build install paths for OpenCV on Windows.
* - [How to build applications with OpenCV inside the "Microsoft Visual Studio"](windows_visual_studio_opencv/windows_visual_studio_opencv.md)
  - Visual Studio project setup for compiling and linking C/C++ applications against OpenCV.
* - [Image Watch: viewing in-memory images in the Visual Studio debugger](windows_visual_studio_image_watch/windows_visual_studio_image_watch.md)
  - Visual Studio extension for inspecting `cv::Mat` and `IplImage_` images live during a debug session.
* - [Building OpenCV on Windows from Source Code using MSYS2 UCRT64 and VS Code (C++)](windows_msys2_vscode/windows_msys2_vscode.md)
...
* - [Introduction to Java Development](desktop_java/java_dev_intro.md)
  - Desktop Java and Scala project setup for OpenCV using Apache Ant or SBT.
* - [Using OpenCV Java with Eclipse](java_eclipse/java_eclipse.md)
  - Eclipse user-library configuration for OpenCV Java development on Windows.
* - [Introduction to OpenCV Development with Clojure](clojure_dev_intro/clojure_dev_intro.md)
  - Clojure REPL setup for interactive OpenCV exploration on the JVM.
* - [Introduction into Android Development](android_binary_package/android_dev_intro.md)
  - Android toolchain setup (Android Studio, JDK, SDK, NDK) and Android development primer for OpenCV work.
* - [Android Development with OpenCV](android_binary_package/dev_with_OCV_on_Android.md)
  - Adding the OpenCV library to an Android Studio project and calling it from Java, experimental Kotlin, or via JNI.
* - [How to run deep networks on Android device](android_binary_package/android_dnn_intro.md)
  - Pretrained deep-learning model inference on Android via OpenCV's `dnn` module, with a MobileNet object-detection sample.
* - [Use OpenCL in Android camera preview based CV application](android_binary_package/android_ocl_intro.md)
...
* - [Getting Started with Images](display_image/display_image.md)
...
* - [Writing documentation for OpenCV](documenting_opencv/documentation.md)
  - Doxygen-based authoring guide for OpenCV docs — features, install, syntax, and conventions.
* - [Transition guide](transition_guide/transition_guide.md)
  - Migration notes for software developers moving C++ code to OpenCV 5.0.
* - [Cross referencing OpenCV from other Doxygen projects](cross_referencing/cross_referencing.md)
...
oneapi_install/oneapi_install
linux_gdb_pretty_printer/linux_gdb_pretty_printer
...
windows_msys2_vscode/windows_msys2_vscode
...
android_binary_package/android_dnn_intro
android_binary_package/android_ocl_intro
macos_install/macos_install
crosscompilation/arm_crosscompile_with_cmake
crosscompilation/crosscompile_with_multiarch
building_tegra_cuda/building_tegra_cuda
building_fastcv/building_fastcv
display_image/display_image
documenting_opencv/documentation
