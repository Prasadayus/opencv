...
(tutorial_config_reference_intro)=
## Introduction
:::{note}
We assume you have read [OpenCV installation overview](general_install.md) tutorial or have experience with CMake.
:::
...
(tutorial_config_reference_general)=
## General options
...
```
:::
(tutorial_config_reference_general_cxx_standard)=
...
:::
(tutorial_config_reference_general_tests)=
...
(tutorial_config_reference_general_modules)=
...
(tutorial_config_reference_general_download)=
...
(tutorial_config_reference_general_cpu)=
...
- [Build hardening](https://en.wikipedia.org/wiki/Hardening_(computing))
...
(tutorial_config_reference_func)=
...
(tutorial_config_reference_func_hetero)=
...
:::{note}
Since OpenCV version 4.0 all CUDA-accelerated algorithm implementations have been moved to the _opencv_contrib_ repository. To build _opencv_ and _opencv_contrib_ together check [Build with extra modules](config_reference.md#tutorial-config-reference-general-contrib).
Some tutorials can be found in the corresponding section: [GPU-Accelerated Computer Vision (cuda module)](https://docs.opencv.org/5.x/da/d2c/tutorial_table_of_content_gpu.html)
:::
:::{seealso}
...
(tutorial_config_reference_func_imgcodecs)=
...
<th>Option</th>
<th>Default</th>
<th>Force build own</th>
</tr></thead>
<tbody>
<tr>
<td rowspan="2"><a href="https://en.wikipedia.org/wiki/Portable_Network_Graphics">PNG</a></td>
<td><a href="https://en.wikipedia.org/wiki/Libpng">libpng</a></td>
<td><code>WITH_PNG</code></td>
<td><em>ON</em></td>
<td><code>BUILD_PNG</code></td>
</tr>
<tr>
<td><a href="https://libspng.org/">libspng(simple png)</a></td>
<td><code>WITH_SPNG</code></td>
<td><em>OFF</em></td>
<td><code>BUILD_SPNG</code></td>
</tr>
<tr>
<td rowspan="2"><a href="https://en.wikipedia.org/wiki/JPEG">JPEG</a></td>
<td><a href="https://en.wikipedia.org/wiki/Libjpeg">libjpeg-turbo</a></td>
<td><code>WITH_JPEG</code></td>
<td><em>ON</em></td>
<td><code>BUILD_JPEG</code></td>
</tr>
<tr>
<td><a href="https://en.wikipedia.org/wiki/Libjpeg">libjpeg</a></td>
<td><code>WITH_JPEG</code></td>
<td><em>OFF</em></td>
<td><code>BUILD_JPEG</code> with <code>BUILD_JPEG_TURBO_DISABLE</code></td>
</tr>
<tr>
<td><a href="https://en.wikipedia.org/wiki/TIFF">TIFF</a></td>
<td><a href="https://en.wikipedia.org/wiki/LibTIFF">LibTIFF</a></td>
<td><code>WITH_TIFF</code></td>
<td><em>ON</em></td>
<td><code>BUILD_TIFF</code></td>
</tr>
<tr>
<td colspan="2"><a href="https://en.wikipedia.org/wiki/WebP">WebP</a></td>
<td><code>WITH_WEBP</code></td>
<td><em>ON</em></td>
<td><code>BUILD_WEBP</code></td>
</tr>
<tr>
<td rowspan="2"><a href="https://en.wikipedia.org/wiki/JPEG_2000">JPEG 2000</a></td>
<td><a href="https://en.wikipedia.org/wiki/OpenJPEG">OpenJPEG</a></td>
<td><code>WITH_OPENJPEG</code></td>
<td><em>ON</em></td>
<td><code>BUILD_OPENJPEG</code></td>
</tr>
<tr>
<td><a href="https://en.wikipedia.org/wiki/JasPer">JasPer</a></td>
<td><code>WITH_JASPER</code></td>
<td><em>ON</em> (see note)</td>
<td><code>BUILD_JASPER</code></td>
</tr>
<tr>
<td colspan="2"><a href="https://en.wikipedia.org/wiki/OpenEXR">OpenEXR</a></td>
<td><code>WITH_OPENEXR</code></td>
<td><em>ON</em></td>
<td><code>BUILD_OPENEXR</code></td>
</tr>
<tr>
<td colspan="2"><a href="https://en.wikipedia.org/wiki/JPEG_XL">JPEG XL</a></td>
<td><code>WITH_JPEGXL</code></td>
<td><em>ON</em></td>
<td>Not supported. (see note)</td>
</tr>
<tr>
<td colspan="2"><a href="https://en.wikipedia.org/wiki/AVIF">AVIF</a></td>
<td><code>WITH_AVIF</code></td>
<td><em>ON</em></td>
<td>Not supported. (see note)</td>
</tr>
</tbody></table></div>
...
(JPEG XL) OpenCV doesn't contain libjxl source code, so `BUILD_JPEGXL` is not supported.
(EXR) OpenCV 5 doesn't contain OpenEXR source code, so `BUILD_OPENEXR` is not supported.
...
(tutorial_config_reference_func_videoio)=
...
Check [OpenCV installation overview](general_install.md) for standalone plugins build instructions.

(tutorial_config_reference_func_core)=
### Parallel processing
...
(tutorial_config_reference_highgui)=
...
:::{note}
OpenCV compiled with Qt support enables advanced _highgui_ interface, see [Qt New Functions](https://docs.opencv.org/5.x/dc/d46/group__highgui__qt.html) for details.
:::
#### OpenGL

`WITH_OPENGL` (default: _OFF_)

OpenGL integration can be used to draw HW-accelerated windows with following backends: GTK, WIN32 and Qt. And enables basic interoperability with OpenGL, see [OpenGL interoperability](https://docs.opencv.org/5.x/d2/d3c/group__core__opengl.html) and [OpenGL support](https://docs.opencv.org/5.x/df/d24/group__highgui__opengl.html) for details.
...
(tutorial_config_reference_install)=
## Installation layout
(tutorial_config_reference_install_root)=
### Installation root
...
```
:::
(tutorial_config_reference_install_comp)=
...
(tutorial_config_reference_misc)=
