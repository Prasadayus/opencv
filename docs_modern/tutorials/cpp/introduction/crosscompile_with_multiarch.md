(tutorial_crosscompile_with_multiarch)=
# MultiArch cross-compilation with Ubuntu/Debian

```{raw} html
<div class="pst-scrollable-table-container"><table class="table opencv-rowspan-table opencv-meta-table">
<tbody>
<tr>
...
:::{note}
`-DCMAKE_TOOLCHAIN_FILE` should be absolute/real file path, not relative path.
:::
