...
This document is focused on building the 3.1.0 version of OpenCV, but the guidelines here may also work for building from the master branch of the git repository. There are differences in some of the CMake options for builds of the 2.4.13 version of OpenCV, which are summarized below in the [Building OpenCV 2.4.X](building_tegra_cuda.md#tutorial-building-tegra-cuda-opencv-24X) section.
...
(tutorial_building_tegra_cuda_getting_the_code)=
...
(tutorial_building_tegra_cuda_preparation)=
...
(tutorial_building_tegra_cuda_configuring)=
...
(tutorial_building_tegra_cuda_building)=
## Building OpenCV
...
(tutorial_building_tegra_cuda_testing)=
## Testing OpenCV
...
(tutorial_building_tegra_cuda_installing)=
## Installing OpenCV
...
(tutorial_building_tegra_cuda_opencv_24X)=
...
(tutorial_building_tegra_cuda_parameter_reference)=
